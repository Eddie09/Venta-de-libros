  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="paginas.php">Libro</a></li>
            <li class="active"><a href="entradas.php">Entradas</a></li>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Entradas<small> Editar</small></h1>
          </div>
          <div class="col-md-2">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="paginas.php" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Libro <span class="badge">39</span></a>
              ...
              <div class="panel-body">
                <form>
                  <div class="form-group">
                    <label>Título de la Libro</label>
                    <input type="text" class="form-control" placeholder="Título de la página" value="Acerca de">
                  </div>
                  <div class="form-group">
                    <label>Mensaje</label>
                    <textarea name="editor1" class="form-control" placeholder="Mensaje">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Add Some Tags..." value="palabra 1, palabra 2">
                  </div>
                  <div class="form-group">
                    <label>Descripción</label>
                    <input type="text" class="form-control" placeholder="Agregar descripción..." value="  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et ">
                  </div>
